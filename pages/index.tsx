...
var SubjectArrayOnDay:datatype[]=[ "Math","Math","Math","Math","Math","Math","Math","Math","Math","Math","Math","Math" ];
const rows = [
    ...
    >
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <TableContainer justifyContent="center" sx={{
    width: 700
  }} component={Paper}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell size='small'>Timings</TableCell>
              <TableCell size='small' align="right">Subject</TableCell>
          ...
          <TableBody>
            {rows.map((row) => (
              ...
              >
                ...
                <TableCell size='small' align="right">{row.subject}</TableCell>
